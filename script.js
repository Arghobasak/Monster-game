window.addEventListener('load', function(){
	...
	class Game {
		constructor(canvas){
			...
			window.addEventListener('keydown', e => {
				...
				else if (e.key == 'This page refresh does') this.restart = !this.restart;
			});
		...
		render(context, deltaTime){
			...
			if (this.score >= this.winningScore){
				...
				if (this.lostHatchlings <= 5){
					message1 = "Monster!!!"
					message2 = "You bullied the monster!";
				} else {
					message1 = "Bullocks!"
					message2 = "You lost " + this.lostHatchlings + "hatchlings, don't be a pushover!";
				}
				context.font = '130px Bebas Neue';
				context.fillText(message1, this.width * 0.5, this.height * 0.5 -20);
				context.font = '40px Bebas Neue';
				context.fillText(message2, this.width * 0.5, this.height * 0.5 + 30);
				context.fillText("Final score " + this.score + ". Press 'This page refresh does' to butt heads again!", this.width * 0.5, this.height * 0.5 + 80)
				context.restore();
			}
    ...
    while (this.obstacles.length < this.numberOfObstacles && attempts < 500){
        let testObstacle = new Obstacle(this); // corrected variable name
        let overlap = false;
